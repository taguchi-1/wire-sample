...
// Source: /Users/b09872/dev/src/github.com/taguchi-1/wire-sample/pkg/domain/repository/user.go
...
func (m *MockUser) Get(ctx context.Context, id string) (*entity.User, error) {
	m.ctrl.T.Helper()
